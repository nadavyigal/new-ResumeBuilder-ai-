...
final class ImproveViewModel {
    ...
    init(
        ...
        analysisService: some ResumeAnalysisServiceProtocol = BackendConfig.useMockServices
            ? MockResumeAnalysisService() : ResumeAnalysisService(),
        optimizationService: some ResumeOptimizationServiceProtocol = BackendConfig.useMockServices
