/**
 * Timeline PDF Template
 *
 * Matches the browser "timeline-ssr" design: timeline visual markers for
 * experience, purple/amber color scheme, creative layout.
 */
...
export const TimelinePdfTemplate: React.FC<PdfTemplateProps> = ({ resume, palette, isRTL }) => {
        ...
        {experience && experience.length > 0 && (
          <View style={s.section}>
            ...
            {experience.map((exp, i) => (
              <View key={i} style={s.timelineEntry} wrap={false}>
                {/* Timeline track */}
                <View style={s.timelineTrack}>
                  <View style={s.timelineDot} />
                  {i < experience.length - 1 && <View style={s.timelineLine} />}
                </View>
                {/* Content */}
