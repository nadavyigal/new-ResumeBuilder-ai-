...
> = {
  full_resume_rewrite: { label: "Strategic Rewrite", variant: "default" },
  achievement_quantifier: { label: "Impact Amplifier", variant: "secondary" },
  ats_optimization_report: { label: "ATS Deep Scan", variant: "outline" },
  professional_summary_lab: { label: "Summary Workshop", variant: "secondary" },
};
